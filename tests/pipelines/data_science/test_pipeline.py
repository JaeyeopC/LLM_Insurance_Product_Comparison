...
# from kedro.pipelines.data_science import create_pipeline as create_ds_pipeline
# from kedro.pipelines.data_science.nodes import split_data
from lab_competitive_analysis.pipelines.data_science.pipeline import create_pipeline as create_ds_pipeline # lab_competitive_analysis/pipelines/data_science/pipeline.py 
from lab_competitive_analysis.pipelines.data_science.nodes import split_data # lab_competitive_analysis/pipelines/data_science/nodes.py 
